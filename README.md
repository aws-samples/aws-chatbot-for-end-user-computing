...
3. Create Lambda deployment packages by creating zip archives of the four python files in the source directory.
   1. Download the four python and the yaml file in the source directory [**https://github.com/aws-samples/aws-chatbot-for-end-user-computing/tree/main/source**](https://github.com/aws-samples/aws-chatbot-for-end-user-computing/tree/main/source)
   2. Create zip archives of the four python files.
